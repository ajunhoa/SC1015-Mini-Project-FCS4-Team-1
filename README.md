...
We will also be using the HDB Resale Price Index ([RPI](https://www.hdb.gov.sg/residential/selling-a-flat/overview/resale-statistics)) to take into account for inflation and better predict resale price. 
